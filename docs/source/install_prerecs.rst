...
3. Some GGG2020 atmospheric profiles computed with `ginput <https://ginput.readthedocs.io/en/latest/>`_. For details on how to generate these atmospheric profiles yourself, check :ref:generateGGG2020profs. 
...
Once you have installed all of the necessary scripts and auxiliary files, you may check out 