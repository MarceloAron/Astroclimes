...
main_telrem_directory = home_directory+'telluric_removal/TauBoo/2018_03_26/ttt/'
...
filename_telrem_SNR_AC = main_telrem_directory+'SNR_logs_ac.txt'
filename_telrem_SNR_PCA = main_telrem_directory+f'SNR_logs_pca_nc_{nc_PCA}.txt'

## Checking if the SNR log files exist and if not, creating them and adding the header
if not os.path.isfile(filename_telrem_SNR_AC):
...
if not os.path.isfile(filename_telrem_SNR_PCA):
...
filename_telrem_MCMC_results_AC = main_telrem_directory+'results_telrem_mcmc_ac.txt'
filename_telrem_MCMC_results_PCA = main_telrem_directory+f'results_telrem_mcmc_pca_nc_{nc_PCA}.txt'
