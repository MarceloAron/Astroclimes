...
filename_inj_rec_SNR_AC = main_inj_rec_directory+'SNR_logs_ac.txt'
filename_inj_rec_SNR_PCA = main_inj_rec_directory+f'SNR_logs_pca_nc_{nc_PCA}.txt'
...
## Filename (with path) to store the MCMC results of each run (this is not the same MCMC as the results_mcmc.txt file from above!)
filename_inj_rec_MCMC_results_AC = main_inj_rec_directory+'results_inj_rec_mcmc_ac.txt'
filename_inj_rec_MCMC_results_PCA = main_inj_rec_directory+f'results_inj_rec_mcmc_pca_nc_{nc_PCA}.txt'
