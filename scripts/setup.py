...
## Set to False if you do not wish to include a model stellar spectrum in the analysis (in which case, the model stellar spectrum will be an array of ones)
include_stelmod = True

## Define path to files containing the model stellar spectrum wavelength and flux, respectively (the models used as default here have them in separate files)
...
## The resulting wavelength distribution will have a resolution of R = c/vel_step
vel_step = 1.0
