...
MCMC_directory = home_directory+'MCMC_results/'
...
filename_telrem_SNR_AC = f'SNR_logs_ac_sf_{scale_factors[0]}.txt'
filename_telrem_SNR_PCA = f'SNR_logs_pca_nc_{nc_PCA}_sf_{scale_factors[0]}.txt'
...
if not os.path.isfile(main_telrem_directory+'all_nights_spec_mod.npy'):
	all_nights_spec_mod = pca_functions.get_mod_cube(n_orders, n_pixels, list_science_spectra, MCMC_directory, atm_profs_directory, filename_mcmc_results, filename_site_values, molecs, molecs_for_cia, generate=True, save_dirname=main_telrem_directory)
