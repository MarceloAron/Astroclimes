...
#import test_utils
#import mod_utils, readers
#dd = '/media/marceloaron/New Volume/PhD/thesis_work/tccon/py-ginput/ginput/priors/'
#sys.path.append(os.path.dirname(dd))
#import tccon_priors, map_maker
...
class TestModMaker(unittest.TestCase, FileComparer):
    ...
    def setUpClass(cls):
        ...
        mmdriver(date_range, test_utils.geos_fp_dir, save_path=test_utils.mod_output_top_dir, keep_latlon_prec=False,
                 save_in_utc=True, site_abbrv=test_utils.test_site, include_chm=True, mode='fp-eta')
