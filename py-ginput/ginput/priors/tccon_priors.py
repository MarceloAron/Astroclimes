...
#dd = '/media/marceloaron/New Volume/PhD/thesis_work/tccon/py-ginput/ginput/mod_maker/'
#sys.path.append(os.path.dirname(dd))
#import tccon_sites
#dd = '/media/marceloaron/New Volume/PhD/thesis_work/tccon/py-ginput/ginput/common_utils/'
#sys.path.append(os.path.dirname(dd))
#import mod_utils, ioutils, readers, writers, run_utils, mod_constants as const
...
def generate_full_tccon_vmr_file(mod_data, utc_offsets, save_dir, product='fp', std_vmr_file=None, site_abbrevs='xx',
...
def generate_tccon_priors_driver(mod_data, utc_offsets, species, site_abbrevs='xx', write_vmrs=False,
                                 gas_name_order=None, keep_latlon_prec=False, flat_outdir=True, product='fp',
...
def cl_driver(date_range, mod_dir=None, mod_root_dir=None, save_dir=None, product='fp',
