...
#dd = '/home/marceloaron/MarceloAron/PhD/thesis_work/tccon/py-ginput/ginput/common_utils/'
#sys.path.append(os.path.dirname(dd))
#import mod_utils, run_utils
#from mod_utils import gravity, check_site_lat_lon_alt
#from mod_constants import ratio_molec_mass as rmm, p_ussa, t_ussa, z_ussa, mass_dry_air, COSource
...
def mod_maker(site_abbrv=None,start_date=None,end_date=None,mode=None,locations=site_dict,HH=12,MM=0,time_step=24,muted=False,lat=None,lon=None,alt=None,save_path=None,ncdf_path=None,keep_latlon_prec=False,**kwargs):
    ...
    simple = {'merradap42':'merra','merradap72':'merra','merraglob':'merra','ncep':'ncep','fpglob':'fp','fpitglob':'fpit', 'fp-eta':'fp'}
